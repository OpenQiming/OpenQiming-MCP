  ...
  <page-container backgroundColor="#F5F7FB" padding="10px" :showHeader="false">
    <div class="case-body">
      <div class="case-box">
        ...
        <p class="title">管理您创建的MCP服务，查看审核状态和使用情况</p>
            ...
            <div class="listCard" v-loading="loading">
              ...
              >
                ...
                <div class="bottom bottomTime">
                  ...
                  <!--
                  <span class="imgs">
                    <img src="/static/mcp/提交审核.svg"  title="提交审核" alt="提交审核" v-if="item.serverStatus == '已创建'"
                        @click.stop="shenheMcp(item)">
                ...
                <div
                  class="bottom-hover"
                  v-if="
                    item.serverStatus == '已创建' && item.accessType != 'MCP'
                  "
                >
                  <!-- <span @click.stop="shenheMcp(item)">提交审核</span> -->
                  <span @click.stop="showTestBox(item.seqId)">测试MCP</span>
                  <span
                ...
                >
                  ...
                  <el-dropdown placement="right" style="padding: 0">
                    <span class="el-dropdown-link" @click.stop="">
                      <i class="el-icon-more"></i>
                    </span>
                    <el-dropdown-menu slot="dropdown">
...
export default {
  ...
  methods: {
      ...
      if (item.accessType != "MCP") {
        ajax
          ...
          .then((r) => {
            if (r.data) {
              ajax
                .post(`${this.$config.gateUrl}/mcpServer/submitReview`, {
                  seqId: item.seqId,
                })
                .then((r) => {
                  if (r.code == 1000) {
    ...
    showTestBox(item) {
       this.mcpId = item;
      //this.mcpId = '1948567745997361152';
      this.showTest = true;
    }
...
.slide-up-enter,
.slide-up-leave-to {
  transform: translateX(-30%) ;  /* 从容器底部下方开始 */
  opacity: 0 ;
}
